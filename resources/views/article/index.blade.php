<x-app-layout>
  <x-slot name="header">
    <div class="flex justify-between">
        ...
        <a href="{{ route('article.create') }}" class="border border-yellow-500 hover:bg-yellow-500 hover:text-white px-4 py-2 rounded-md">CREATE</a>
    </div>
  </x-slot>
                        ...
                        @foreach ($articles as $article)
                            <tr>
                                ...
                                <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                    {{-- <a href="{{ route('user.show', $article->id) }}" class="border border-blue-500 hover:bg-blue-500 hover:text-white px-4 py-2 rounded-md">SHOW</a> --}}
